...
Players must have the ability to input Chinese characters using their Operating System's keyboard. If they cannot input Chinese, they will not be able to progress through the game.

HOW TO PLAY:

1. Download and run the .exe file
2. Navigate through the world using cardinal directions (i.e. north, south, east, west). If you need any help with how to do this, type 'h' or 'help' into the command line.
3. Defeat the enemies and find the Golden Chalice!